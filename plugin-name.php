...
| services providers through the config/prefix_plugin.php configuration file.
*/
...
|--------------------------------------------------------------------------
|
| Register theme Plugin. You can manage the list of hooks
| through the config/prefix_plugin.php configuration file.
*/
